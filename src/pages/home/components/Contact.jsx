...
import { FaEnvelope, FaPhone, FaRegAddressCard, FaWhatsapp } from 'react-icons/fa6';
...
const Contact = () => {
    ...
    return (
        <section id='contact' className='w-11/12 md:container mx-auto py-14 md:py-24'>
            <div className="space-y-4 w-full md:w-9/12 text-center mx-auto mb-14">
                ...
                <p>Feel free to reach out if you have any questions, collaboration opportunities, or simply want to connect. I’m always open to new conversations and would love to hear from you!Feel free to reach out if you have any questions, collaboration opportunities, or simply want to connect. I’m always open to new conversations and would love to hear from you!</p>
            </div>
