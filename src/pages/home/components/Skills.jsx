        ...
        <section id='skills' className='w-11/12 md:container lg:w-9/12 mx-auto py-14 md:py-24'>
            <div>
                <div className="space-y-4 w-full md:w-9/12 text-center mx-auto">
                    ...
                    <p>I specialize in creating responsive and interactive web applications, leveraging both frontend and backend technologies</p>
                </div>
                <div className="grid md:grid-cols-2 mt-14 gap-8 md:gap-12 w-10/12 mx-auto">
